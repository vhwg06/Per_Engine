...
## 13. Execution Integrity & Task Completion Rules

These rules prevent false progress, silent regressions, and invalid task completion.
They are **mandatory** and override convenience or subjective judgment.

### 13.1 No Delete-to-Pass

* Code or tests **must not be removed** solely to avoid compilation or execution failures.
* Removing a test requires:

  * A documented replacement **or**
  * An explicit, reviewed waiver describing the accepted risk.

**Violation:** Deleting a failing test and marking the task as complete.

---

### 13.2 Green Pipeline Is a Hard Requirement

* A task may be marked **DONE** only if the latest CI run is green.
* Compilation errors, execution failures, or skipped critical tests block completion.

**Rule of thumb:**
DONE = last pipeline run is green.

---

### 13.3 Completion Criteria Are Binding

* Every task must define explicit completion criteria.
* A task is complete **only when all criteria are met**, not when effort feels sufficient.

**Violation:** Declaring a task done without satisfying its stated criteria.

---

### 13.4 Execution Failure Means BLOCKED, Not DONE

* Any of the following automatically blocks a task:

  * Compilation errors
  * Runtime failures
  * Failed or skipped required tests

**Rule:** Execution failure changes task state to **BLOCKED**, never **DONE**.

---

### 13.5 No Self-Certification by Agents or Automation

* Agents and automation may report results, but may not declare work “good enough”.
* Claims such as “not critical” or “already covered” require human review and evidence.

---

### 13.6 Audit Evidence Is Required

Every completed task must include an audit line:

* Commit reference
* CI run reference
* Tests or validations proving completion

Without audit evidence, completion is invalid.
